...
class CustomSurveyDataTest {
    private CustomSurveyData customSurvey1;
    private CustomSurveyData customSurvey2;
    @BeforeEach
    void setUp() {
        customSurvey1 = new CustomSurveyData();
        customSurvey2 = new CustomSurveyData(
                1, "name", "description",
                1, "questionType",
                1, "question", 2, "answer");
    }
