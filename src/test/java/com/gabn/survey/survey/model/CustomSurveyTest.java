...
class CustomSurveyTest {
    private CustomSurvey customSurvey1;
    private CustomSurvey customSurvey2;
    @BeforeEach
    void setUp() {
        customSurvey1 = new CustomSurvey();
        customSurvey2 = new CustomSurvey(
                1, "name", "description",
                1, "questionType",
                1, "question", 2, "answer");
    }
